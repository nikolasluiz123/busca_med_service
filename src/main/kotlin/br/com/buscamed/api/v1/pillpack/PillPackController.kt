...
class PillPackController(
    ...
    /**
     * Processa a requisição multipart contendo a imagem de uma cartela de comprimidos.
    ...
    /**
     * Processa a requisição contendo texto bruto extraído de uma cartela de comprimidos.
